...
public interface DockerService {
	...
	public ResponseEntity<ServiceResponse> OnboardingWithAuthentication(JsonRequest<Crediantials> crediantials,
			HttpServletResponse responses) throws AcumosServiceException;
	...
	ResponseEntity<ServiceResponseTag7.0.0> advancedModelOnboard(HttpServletRequest request, MultipartFile model,
